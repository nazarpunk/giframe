...
const map = {
	...
	iarm: {type: 0, name: `(armorType) armor : Armor Type`, singleline : true},
	icla: {type: 0, name: `(itemClass) class : Classification`, singleline : true},
	...
	icid: {type: 0, name: `(abilCode) cooldownID : Cooldown Group`, singleline : true},
	...
	udaa: {type: 0, name: `(abilCode) auto : Default Active Ability`, singleline : true},
	...
	upra: {type: 0, name: `(attributeType) Primary : Primary Attribute`, singleline : true},
	...
	uhrt: {type: 0, name: `(regenType) regenType : Hit Points Regeneration Type`, singleline : true},
	...
	utyp: {type: 0, name: `(unitClass) type : Unit Classification`, singleline : true},
	...
	uabt: {type: 0, name: `(aiBuffer) buffType : AI Placement Type`, singleline : true},
	...
	uarm: {type: 0, name: `(armorType) armor : Armor Type`, singleline : true},
	...
	uver: {type: 3, name: `(versionFlags) fileVerFlags : Model File - Extra Versions`, singleline : true},
	...
	utco: {type: 3, name: `(teamColor) teamColor : Team Color`, singleline : true},
