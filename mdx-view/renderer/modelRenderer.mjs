import {NodeFlags, LayerShading, FilterMode, TextureFlags} from '../model.mjs';
import {vec3, quat, mat3, mat4} from './../gl-matrix/index.mjs';
import {mat4fromRotationOrigin, getShader, isWebGL2} from './util.mjs';
...
export class ModelRenderer {
    ...
    skeletonShaderProgram;
    skeletonVertexShader;
    skeletonFragmentShader;
    skeletonShaderProgramLocations;
    skeletonVertexBuffer;
    skeletonColorBuffer;
    model;
    interp;
    rendererData;
    ...
    setTextureImage(path, img, flags) {
    ...
    setTextureImageData(path, imageData, flags) {
        this.rendererData.textures[path] = this.gl.createTexture();
        this.gl.bindTexture(this.gl.TEXTURE_2D, this.rendererData.textures[path]);
        // this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL, true);
    ...
    setTextureCompressedImage(path, format, imageData, ddsInfo, flags) {
        this.rendererData.textures[path] = this.gl.createTexture();
        this.gl.bindTexture(this.gl.TEXTURE_2D, this.rendererData.textures[path]);
