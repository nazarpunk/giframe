import {ParticleEmitter2FilterMode, ParticleEmitter2Flags, ParticleEmitter2FramesFlags} from '../model.mjs';
import {vec3, vec4} from './../gl-matrix/index.mjs';
import {ModelInterp} from './modelInterp.mjs';
import {degToRad, rand, getShader} from './util.mjs';
import {lerp} from './interp.mjs';

const rotateCenter = vec3.fromValues(0, 0, 0);
