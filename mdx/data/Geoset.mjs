...
import {CountListOld} from "../parser/CountListOld.mjs";
...
export class Geoset {
	...
	read(view) {
		...
		this.vertexPositions = this.parser.add(new CountListOld(0x58545256/*VRTX*/, new Float32List(3)));
		this.vertexNormals = this.parser.add(new CountListOld(0x534d524e/*NRMS*/, new Float32List(3)));
		this.faceTypeGroups = this.parser.add(new CountListOld(0x50595450/*PTYP*/, Uint32));
		this.faceGroups = this.parser.add(new CountListOld(0x544e4350/*PCNT*/, Uint32));
		this.faces = this.parser.add(new CountListOld(0x58545650/*PVTX*/, Uint16));
		this.vertexGroups = this.parser.add(new CountListOld(0x58444e47/*GNDX*/, Uint8));
		this.matrixGroups = this.parser.add(new CountListOld(0x4347544d/*MTGC*/, Uint32));
		this.matrixIndices = this.parser.add(new CountListOld(0x5354414d/*MATS*/, Uint32));
		...
		this.sequenceExtents = this.parser.add(new CountListOld(null, Extent));
		if (this.reader.version > 800) {
			this.tangents = this.parser.add(new CountListOld(0x474e4154/*TANG*/, new Float32List(4)));
			this.skins = this.parser.add(new CountListOld(0x4e494b53/*SKIN*/, Uint8));
		}
		this.textureCoordinateSets = this.parser.add(new CountListOld(0x53415655/*UVAS*/, TextureCoordinateSet));
